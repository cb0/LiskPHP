...
namespace Lisk\Cli\MultiSignature;
...
class CreateAccount extends AbstractCliAction
{
    ...
    {
        return call_user_func_array([$client, 'createMultiSignatureAccount'], $this->getArguments($args));
    }
    ...
    public function setRequiredArguments()
    {
        $this->requiredArguments = [
            Parameters::SECRET,
            Parameters::LIFETIME,
            Parameters::MINSIGNATURES,
            Parameters::KEYSGROUP
        ];
    }
